// this file is tutorial material from:https://www.youtube.com/watch?v=0ik6X4DJKCc&list=PLillGF-RfqbbnEGy3ROiLWk7JMCuSyQtX&index=2
...
function buttonClick(e) {
  console.log('button clicked!');
  //只是你沒有將header-title賦予給任一個變量，你還是可以透過js操控他
  //這個概念可能是我們已經有button作為操控html頁面的entry poin了，之後在html頁面上的任一元素都可以透過此function間接操作。
  document.getElementById('header-title').textContent = 'Changed'
  console.log(e.target);
  //滑鼠點擊button時所在的瀏覽器x軸位置 
  console.log(e.clientX);
  //滑鼠點擊button時所在的元素(button)x軸位置 
  console.log(e.offsetX);
}
...
//mouseenter&mouseleave較有針對母元素的意味？
// box.addEventListener('mouseenter', runEvent);
// box.addEventListener('mouseleave', runEvent);
